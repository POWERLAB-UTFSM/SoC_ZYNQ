proc getPresetInfo {} {
  return [dict create name {Zedboard_PSpreset_interrupt} description {Zedboard_PSpreset_interrupt}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {Zedboard_PSpreset_interrupt} ]
}
