...
#
# pwm_zynq_ax7020.tcl: Tcl script for re-creating project 'pwm_zynq_ax7020'
#
# Generated by Vivado on Tue Mar 14 12:41:26 -0300 2023
...
#
# 1. This project restoration tcl script (pwm_zynq_ax7020.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/SoC_ZYNQ/Vivado/projects/pwm_zynq_ax7020/pwm_zynq_ax7020/pwm_zynq_ax7020.srcs/utils_1/imports/synth_1/pwm_1_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "D:/SoC_ZYNQ/Vivado/sources/xdc/Alinx_ax7020__pwm.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/pwm_zynq_ax7020/pwm_zynq_ax7020.srcs/utils_1/imports/synth_1/pwm_1_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "pwm_zynq_ax7020"
...
set script_file "pwm_zynq_ax7020.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/pwm_zynq_ax7020"]"
...
proc cr_bd_pwm_1 { parentCell } {
  ...
  set IO1_1P [ create_bd_port -dir O IO1_1P ]
  set IO1_4N [ create_bd_port -dir O -type intr IO1_4N ]
...
\
  ...
  connect_bd_net -net AXI_CPWM_0_interrupt [get_bd_ports IO1_4N] [get_bd_pins AXI_CPWM_0/interrupt]
  connect_bd_net -net AXI_CPWM_0_pwm_1_A [get_bd_ports IO1_1N] [get_bd_pins AXI_CPWM_0/pwm_1_A]
  connect_bd_net -net AXI_CPWM_0_pwm_1_B [get_bd_ports IO1_1P] [get_bd_pins AXI_CPWM_0/pwm_1_B]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.654545",
   "Default View_TopLeft":"-307,-649",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS-threadsafe
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1120 -y -370 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1120 -y -100 -defaultsOSRD
preplace port port-id_IO1_1N -pg 1 -lvl 4 -x 1120 -y -320 -defaultsOSRD
preplace port port-id_IO1_4N -pg 1 -lvl 4 -x 1120 -y -160 -defaultsOSRD
preplace port port-id_IO1_1P -pg 1 -lvl 4 -x 1120 -y -300 -defaultsOSRD
preplace portBus gpio_io_o_0 -pg 1 -lvl 4 -x 1120 -y 20 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 180 -y -100 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 3 -x 940 -y 10 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 940 -y -510 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 2 -x 580 -y 20 -defaultsOSRD
preplace inst AXI_CPWM_0 -pg 1 -lvl 2 -x 580 -y -240 -defaultsOSRD
preplace netloc AXI_CPWM_0_interrupt 1 2 2 NJ -160 NJ
preplace netloc AXI_CPWM_0_pwm_1_A 1 2 2 NJ -320 NJ
preplace netloc AXI_CPWM_0_pwm_1_B 1 2 2 NJ -300 NJ
preplace netloc axi_gpio_0_gpio_io_o 1 3 1 N 20
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -20 -210 400 -400 770
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 380 -50n
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 410 -90 780
preplace netloc processing_system7_0_DDR 1 1 3 390J -380 750J -370 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 390J -100 NJ -100 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 380 -590 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 3 410 -390 760J -360 1100
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 2 790 -170 1090
levelinfo -pg 1 -40 180 580 940 1120
pagesize -pg 1 -db -bbox -sgen -40 -650 1280 200
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse pwm_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/pwm_zynq_ax7020/pwm_zynq_ax7020.gen/sources_1/bd/pwm_1/hdl/pwm_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/pwm_zynq_ax7020.srcs/utils_1/imports/synth_1/pwm_1_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/pwm_zynq_ax7020.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/pwm_zynq_ax7020.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/pwm_zynq_ax7020.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
