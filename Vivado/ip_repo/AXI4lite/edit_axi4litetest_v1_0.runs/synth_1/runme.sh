...
HD_PWD='e:/repos/powerlab-utfsm/soc_zynq/vivado/ip_repo/axi4lite/edit_axi4litetest_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi4litetest_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi4litetest_v1_0.tcl
