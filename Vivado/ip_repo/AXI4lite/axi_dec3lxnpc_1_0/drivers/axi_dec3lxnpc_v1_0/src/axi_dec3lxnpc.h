...
static INLINE void AXI_DEC3LXNPC_mWrite_commtype(UINTPTR BaseAddress, u8 Value){
	HWREG(BaseAddress + AXI_DEC3LXNPC_S00_AXI_SLV_REG2_OFFSET) = (HWREG(BaseAddress + AXI_DEC3LXNPC_S00_AXI_SLV_REG2_OFFSET) & 0b11111111111111111111111111110011) + ((Value & 0b0000011) << 2);
}

static INLINE void AXI_DEC3LXNPC_mWrite_convtype(UINTPTR BaseAddress, u8 Value){
	HWREG(BaseAddress + AXI_DEC3LXNPC_S00_AXI_SLV_REG2_OFFSET) = (HWREG(BaseAddress + AXI_DEC3LXNPC_S00_AXI_SLV_REG2_OFFSET) & 0b11111111111111111111111111111100) + ((Value & 0b0000011));
}
